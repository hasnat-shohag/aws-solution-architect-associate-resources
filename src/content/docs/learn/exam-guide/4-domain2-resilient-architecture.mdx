...
**২৬% of scored content** — দ্বিতীয় বৃহত্তম ভাগ। দুটি task statement: scalable/loosely coupled ডিজাইন এবং HA/fault-tolerant ডিজাইন। মাইক্রোসার্ভিসেস ও ব্লু/গ্রিন থিমের বেশিরভাগ বিষয় এই ডোমেইনেই পড়ে।
...
- load balancing (ALB), database proxy (RDS Proxy);
...
**পরীক্ষার সংকেত:** RPO/RTO ছোট হলে খরচ বাড়ে — backup/restore (সবচেয়ে ধীর) → pilot light → warm standby → active-active (সবচেয়ে দ্রুত)। প্রশ্নে ব্যবসায়িক সীমা ও বাজেট দুটোই খেয়াল করুন।
...
- **"auto scaling-ই সব সমস্যার সমাধান"** — scaling কাউন্টার মেট্রিকের উপর নির্ভর করে; মেট্রিক ভুল হলে scaling ঠিক সময়ে ঘটে না।
