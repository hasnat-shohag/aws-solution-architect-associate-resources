...
এই লেসনটি গাইডের দুই প্রান্তকে জোড়া লাগায়: পেজ ১-এর response types বলে প্রশ্ন *দেখতে* কেমন, আর appendix-এর technologies-and-concepts তালিকা বলে প্রশ্ন *কোথা থেকে* তৈরি হয়। দুটো একসঙ্গে ধরলে প্রশ্ন পড়ার একটা পদ্ধতি দাঁড়ায় — প্রথমে প্রশ্নের ক্রিয়া চেনা, তারপর ডোমেইন বাছাই, শেষে অপশন ছাঁটা।
...
flowchart LR
    ...
    B --> C[ডোমেইন বাছাই]
    C --> D[অপশন ছাঁটা]
    D --> E[সীমাবদ্ধতায় সবচেয়ে খাপে উত্তর]
```
...
3. **অপশন ছাঁটুন** — ডোমেইন ধরা হয়ে গেলে ভুল ডোমেইনের সমাধান দেওয়া অপশনগুলো প্রথমেই বাদ পড়ে; বাকিদের মধ্যে প্রশ্নের সীমাবদ্ধতাই চূড়ান্ত বাছাইয়ের মাপকাঠি।
...
- **"অপশন বারবার পড়ে সঠিকটি খুঁজব"** — বরং প্রথমে ক্রিয়া ও সীমাবদ্ধতা চিহ্নিত করুন; ডোমেইন ধরা পড়লে অর্ধেক অপশন নিজেই বাদ।
