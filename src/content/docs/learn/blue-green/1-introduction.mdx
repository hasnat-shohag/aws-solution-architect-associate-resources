...
description: দুই একই পরিবেশের মাঝে traffic shift করে near zero-downtime release ও দ্রুত rollback-এর পদ্ধতি।
theme: blue-green
order: 1
pages: [1, 3]
...
keywords:
  - term: Blue/Green Deployment
    bn: দুই একই পরিবেশের মাঝে traffic সরিয়ে রিলিজ করার কৌশল
  ...
  - term: Green Environment
    ...
    tip: test শেষে blue-এর কাছ থেকে traffic নেয়।
  ...
  - term: Blast Radius
    ...
    tip: blue/green এটা ছোট রাখে — শুধু green-এর traffic প্রভাবিত হয়।
  - term: Rollback
